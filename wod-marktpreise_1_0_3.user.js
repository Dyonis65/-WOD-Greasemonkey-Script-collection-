...
// @require https://greasyfork.org/scripts/389206-supergm/code/SuperGM.js
...
var  speicherOption = GM_SuperValue.get(welt + "_VG_" + VGListe[i], "");

//		alert("+++" + speicherOption + "-+++");
		if (speicherOption !== undefined )
		{
...
GM_SuperValue.set(welt + "_VG_" + VGListe[i], select.selectedIndex + "+++" + wert.value);
}
}
